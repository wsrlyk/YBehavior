...
namespace YBehavior
{
	...
	{
	public:
		static Bimap<OperationType, STRING> s_OperatorMap;
	...
	public:
		...
		template<>
		static bool Compare<AgentWrapper>(SharedDataEx* pData, ISharedVariableEx* pLeft, ISharedVariableEx* pRight, OperationType op)
		{
			return false;
		}
		template<>
		static void Calculate<AgentWrapper>(SharedDataEx* pData, ISharedVariableEx* pLeft, ISharedVariableEx* pRight0, ISharedVariableEx* pRight1, OperationType op)
		{

		}
		template<>
		static void Calculate<String>(SharedDataEx* pData, ISharedVariableEx* pLeft, ISharedVariableEx* pRight0, ISharedVariableEx* pRight1, OperationType op)
		{
